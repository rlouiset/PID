...
parser.add_argument("--data-path", default="/Users/robinlouiset/Downloads/sarcasm.pkl", type=str)
...
class SarcasmDataset(Dataset):
    """
    MUsTARD dataset. Returns raw temporal sequences (T=50, D) for two modalities.
    Labels are ±1 in the pickle; remapped to 0/1 here.
...
if __name__ == "__main__":
    ...
    print(f"Loading MUsTARD  [{pair_name}]  dims=({dim0}, {dim1})")
    ...
    # ========= 2. BUILD MODEL =========
    # Encoders: (batch, 50, D) → (batch, hidden_dim)
    ...
    y_pred_dict = return_redundancy_test_performances(
        ...
        f"sarcasm_ccs_source_{pair_name}",
