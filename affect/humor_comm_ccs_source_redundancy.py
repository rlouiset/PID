"""
CoMM/FactorCL architecture for UR-FUNNY PID estimation.
...
parser.add_argument("--seq-len", default=30, type=int,
                    help="Sequence length (30 for UR-FUNNY)")
...
class HumorDataset(Dataset):
    """
    UR-FUNNY dataset. Labels are already binary (0/1).
    ...
    def __init__(self, split_dict, mod0_key="vision", mod1_key="text",
        ...
        self.labels = torch.from_numpy(
            split_dict["labels"].squeeze().astype(np.int64))
...
class CoMMEncoder(nn.Module):
    ...
    """
    def __init__(self, n_features, embed_dim=40, max_seq_len=20,
...
class CoMMMultimodalModel(nn.Module):
    ...
    def __init__(self, mod0_dim, mod1_dim, num_classes,
                 embed_dim=40, seq_len=20, positional_encoding=False):
        super().__init__()
