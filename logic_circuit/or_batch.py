...
class ORDataset(Dataset):
    ...
    def __getitem__(self, idx):
        x1 = self.x1[idx] + torch.randn(1) * self.noise_std
        x2 = self.x2[idx] + torch.randn(1) * self.noise_std
...
if __name__ == "__main__":
    ...
    train_set = ORDataset(n_train, noise_std=0.1)
    test_set = ORDataset(n_test, noise_std=0.1)
