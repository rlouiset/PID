...
# TRAIN
y_train_standardized = standardize_data(train_set.y.float())
X1_train_standardized = standardize_data(train_set.x1)
X2_train_standardized = standardize_data(train_set.x2)
...
# TEST
y_test_standardized = standardize_data(test_set.y.float())
X1_test_standardized = standardize_data(test_set.x1)
X2_test_standardized = standardize_data(test_set.x2)
