...
from synthetic.supervised_learning import train, test
...
if __name__ == "__main__":
    ...
    unicity_predictors = [nn.Sequential(Linear(args.hidden_dim, args.hidden_dim).to(device),
                                nn.ReLU(),
                                Linear(args.hidden_dim, args.hidden_dim).to(device))
