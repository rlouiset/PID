...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-data", default=20000, type=int)
    ...
    parser.add_argument("--transform-dim", default=50, type=int)
    parser.add_argument('--setting', default='mix4', type=str)
    parser.add_argument('--mix-ratio', nargs='+', default=[0.5,0.5,1], type=float)
    parser.add_argument('--num-classes', default=2, type=int)
    parser.add_argument('--out-path', default='../data/experiments', type=str)
    ...
    save_data(data, "original_DATA_{}.pickle".format(args.setting))
