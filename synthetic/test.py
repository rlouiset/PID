...
print(data['and'][0][:10, 0])
print(data['and'][1][:10, 0])
print(data['and'][2][:10, 0])
...
import pickle
with open('synthetic/experiments/DATA_redundancy_cluster_num_classes=4.pickle', 'rb') as f:
...
import pickle
with open('synthetic/experiments/DATA_synergy_cluster_num_classes=4.pickle', 'rb') as f:
    dataset = pickle.load(f)
data = (dataset['test']['0'], dataset['test']['1'], dataset['test']['label'])
P, maps = convert_data_to_distribution(*data)
test(P)
...
import pickle
with open('synthetic/experiments/DATA_uniqueness0_cluster_num_classes=4.pickle', 'rb') as f:
    dataset = pickle.load(f)
data = (dataset['test']['0'], dataset['test']['1'], dataset['test']['label'])
P, maps = convert_data_to_distribution(*data)
test(P)
...
import pickle
with open('synthetic/experiments/DATA_uniqueness1_cluster_num_classes=4.pickle', 'rb') as f:
    dataset = pickle.load(f)
data = (dataset['test']['0'], dataset['test']['1'], dataset['test']['label'])
P, maps = convert_data_to_distribution(*data)
test(P)